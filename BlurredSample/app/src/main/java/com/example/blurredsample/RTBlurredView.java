...
public class RTBlurredView extends RelativeLayout {
    ...
    public RTBlurredView(Context context) {
        super(context);
        init(context);
    }

    public RTBlurredView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
        initAttr(context, attrs);
    }

    public RTBlurredView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setBlurredLevel(int level) {
        ...
        if(level != currentBlurLevel) {
            ...
            if(radius > 0) {
                mBlurredBitmap = BlurBitmap.blur((level/4.0f), mContext, mOriginBitmap);
            } else {
